...
namespace Xaminals.Views
{
    ...
    public partial class KebukeDetailPage : ContentPage
    {
        public KebukeDetailPage()
        {
            InitializeComponent();
        }
        ...
        void LoadDrink(string name)
        {
            try
            {
                Drink drink = KebukeData.Kebuke.FirstOrDefault(a => a.Name == name);
        ...
        private void ice1_Clicked(object sender, EventArgs e)
        {
            ...
            if (content.BackgroundColor == Color.FromHex("#dddddd"))
            {
                ...
                ice8.BackgroundColor = Color.FromHex("#dddddd");
            }
            else
            {
                content.BackgroundColor = Color.FromHex("#dddddd");
        ...
        private void ice8_Clicked(object sender, EventArgs e)
        {
            var content = (Button)sender;
            if (content.BackgroundColor == Color.FromHex("#dddddd"))
            {
        ...
        private void sugar1_Clicked(object sender, EventArgs e)
        {
            ...
            if (content.BackgroundColor == Color.FromHex("#dddddd"))
            {
                ...
                sugar7.BackgroundColor = Color.FromHex("#dddddd");
            }
            else
            {
                content.BackgroundColor = Color.FromHex("#dddddd");
        ...
        private void sugar7_Clicked(object sender, EventArgs e)
        {
            var content = (Button)sender;
            if (content.BackgroundColor == Color.FromHex("#dddddd"))
            {
        ...
        private void buy(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (ice8.BackgroundColor == Color.FromHex("#0000ff"))
                {
                    totalinfo.Text = totalinfo.Text + ice8.Text + " ";
                }
                ...
                if (sugar7.BackgroundColor == Color.FromHex("#0000ff"))
                {
                    totalinfo.Text = totalinfo.Text + sugar7.Text + " ";
                }
