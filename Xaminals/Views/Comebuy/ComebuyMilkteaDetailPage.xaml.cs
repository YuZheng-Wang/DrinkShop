...
namespace Xaminals.Views
{
    ...
    public partial class ComebuyMilkteaDetailPage : ContentPage
    {
        public ComebuyMilkteaDetailPage()
        {
            InitializeComponent();
        }
        public string Name
        ...
        void LoadDrink(string name)
        {
            try
            {
                Drink drink = ComebuyMilkteaData.ComebuyMilktea.FirstOrDefault(a => a.Name == name);
