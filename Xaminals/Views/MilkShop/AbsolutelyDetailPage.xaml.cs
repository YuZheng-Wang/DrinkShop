...
namespace Xaminals.Views
{
    ...
    public partial class AbsolutelyDetailPage : ContentPage
    {
        public string Name
        {
            set
        ...
        void LoadDrink(string name)
        {
            try
            {
                Drink drink = Data.AbsolutelyRecommend.Absolutely.FirstOrDefault(a => a.Name == name);
