...
namespace Xaminals.Views
{
    ...
    public partial class ComebuyFruitteaDetailPage : ContentPage
    {
        public ComebuyFruitteaDetailPage()
        {
            InitializeComponent();
        }
        public string Name
        ...
        void LoadDrink(string name)
        {
            try
            {
                Drink drink = ComebuyFruitteaData.ComebuyFruittea.FirstOrDefault(a => a.Name == name);
