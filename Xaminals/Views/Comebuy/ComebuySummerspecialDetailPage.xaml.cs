...
namespace Xaminals.Views
{
    ...
    public partial class ComebuySummerspecialDetailPage : ContentPage
    {
        public ComebuySummerspecialDetailPage()
        {
            InitializeComponent();
        }
        public string Name
        ...
        void LoadDrink(string name)
        {
            try
            {
                Drink drink = ComebuySummerspecialData.ComebuySummerspecial.FirstOrDefault(a => a.Name == name);
        ...
        {
            if (sizel.BackgroundColor == Color.FromHex("#dddddd") |
