...
namespace Xaminals.Views
{
    ...
    public partial class ComebuyWinterspecialDetailPage : ContentPage
    {
        public ComebuyWinterspecialDetailPage()
        {
            InitializeComponent();
        }
        public string Name
        ...
        void LoadDrink(string name)
        {
            try
            {
                Drink drink = ComebuyWinterspecialData.ComebuyWinterspecial.FirstOrDefault(a => a.Name == name);
        ...
        private void extra13_Clicked(object sender, EventArgs e)
        {
            var content = (Button)sender;
            if (content.BackgroundColor == Color.FromHex("#dddddd"))
            {
        ...
        {
            if ((sizem.BackgroundColor == Color.FromHex("#dddddd") & sizel.BackgroundColor == Color.FromHex("#dddddd")) |
                (ice1.BackgroundColor == Color.FromHex("#dddddd") & ice2.BackgroundColor == Color.FromHex("#dddddd") & ice3.BackgroundColor == Color.FromHex("#dddddd") & ice4.BackgroundColor == Color.FromHex("#dddddd") & ice5.BackgroundColor == Color.FromHex("#dddddd")) |
                (sugar1.BackgroundColor == Color.FromHex("#dddddd") & sugar2.BackgroundColor == Color.FromHex("#dddddd") & sugar3.BackgroundColor == Color.FromHex("#dddddd") & sugar4.BackgroundColor == Color.FromHex("#dddddd") & sugar5.BackgroundColor == Color.FromHex("#dddddd")) |
                quantity.Text == "0")
            {
            ...
            else
            {
                ...
                {
                    totalinfo.Text = totalinfo.Text + extra7.Text + " ";
                }
                if (extra8.BackgroundColor == Color.FromHex("#0000ff"))
                {
                    totalinfo.Text = totalinfo.Text + extra8.Text + " ";
                }
                if (extra9.BackgroundColor == Color.FromHex("#0000ff"))
                {
                    totalinfo.Text = totalinfo.Text + extra9.Text + " ";
                }
                if (extra10.BackgroundColor == Color.FromHex("#0000ff"))
                {
                    totalinfo.Text = totalinfo.Text + extra10.Text + " ";
                }
                if (extra11.BackgroundColor == Color.FromHex("#0000ff"))
                {
                    totalinfo.Text = totalinfo.Text + extra11.Text + " ";
                }
                if (extra12.BackgroundColor == Color.FromHex("#0000ff"))
                {
                    totalinfo.Text = totalinfo.Text + extra12.Text + " ";
                }
                if (extra13.BackgroundColor == Color.FromHex("#0000ff"))
                {
                    totalinfo.Text = totalinfo.Text + extra13.Text + " ";
                }
                if (extra14.BackgroundColor == Color.FromHex("#0000ff"))
                {
                    totalinfo.Text = totalinfo.Text + extra14.Text + " ";
                }
                if (extra15.BackgroundColor == Color.FromHex("#0000ff"))
                {
                    totalinfo.Text = totalinfo.Text + extra15.Text + " ";
                }
