...
namespace Xaminals.Views
{
    ...
    public partial class FreshDetailPage : ContentPage
    {
        ...
        void LoadDrink(string name)
        {
            try
            {
                Drink drink = FreshData.Fresh.FirstOrDefault(a => a.Name == name);
        ...
        private void buy(object sender, EventArgs e)
        {
            if ((sizem.BackgroundColor == Color.FromHex("#dddddd") & sizel.BackgroundColor == Color.FromHex("#dddddd")) | 
                (ice1.BackgroundColor==Color.FromHex("#dddddd") & ice2.BackgroundColor == Color.FromHex("#dddddd") & ice3.BackgroundColor == Color.FromHex("#dddddd") & ice4.BackgroundColor == Color.FromHex("#dddddd")) | 
