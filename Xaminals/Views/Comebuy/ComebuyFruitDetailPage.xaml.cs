...
namespace Xaminals.Views
{
    ...
    public partial class ComebuyFruitDetailPage : ContentPage
    {
        public ComebuyFruitDetailPage()
        {
            InitializeComponent();
        }
        public string Name
        ...
        void LoadDrink(string name)
        {
            try
            {
                Drink drink = ComebuyFruitData.ComebuyFruit.FirstOrDefault(a => a.Name == name);
