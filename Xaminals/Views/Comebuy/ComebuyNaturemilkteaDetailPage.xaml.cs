...
namespace Xaminals.Views
{
    ...
    public partial class ComebuyNaturemilkteaDetailPage : ContentPage
    {
        public ComebuyNaturemilkteaDetailPage()
        {
            InitializeComponent();
        }
        public string Name
        ...
        void LoadDrink(string name)
        {
            try
            {
                Drink drink = ComebuyNaturemilkteaData.ComebuyNaturemilktea.FirstOrDefault(a => a.Name == name);
