...
namespace Xaminals.Views
{
    ...
    public partial class MilkTeaDetailPage : ContentPage
    {
        public MilkTeaDetailPage()
        {
            InitializeComponent();
        }
        ...
        void LoadDrink(string name)
        {
            try
            {
                Drink drink = MilkTeaData.MilkTea.FirstOrDefault(a => a.Name == name);
        ...
        private void buy(object sender, EventArgs e)
        {
            if ((sizem.BackgroundColor == Color.FromHex("#dddddd") & sizel.BackgroundColor == Color.FromHex("#dddddd")) |
                (ice1.BackgroundColor == Color.FromHex("#dddddd") & ice2.BackgroundColor == Color.FromHex("#dddddd") & ice3.BackgroundColor == Color.FromHex("#dddddd") & ice4.BackgroundColor == Color.FromHex("#dddddd") & ice5.BackgroundColor == Color.FromHex("#dddddd") & ice6.BackgroundColor == Color.FromHex("#dddddd") & ice7.BackgroundColor == Color.FromHex("#dddddd")) |
                (sugar1.BackgroundColor == Color.FromHex("#dddddd") & sugar2.BackgroundColor == Color.FromHex("#dddddd") & sugar3.BackgroundColor == Color.FromHex("#dddddd") & sugar4.BackgroundColor == Color.FromHex("#dddddd") & sugar5.BackgroundColor == Color.FromHex("#dddddd") & sugar6.BackgroundColor == Color.FromHex("#dddddd")) |
                quantity.Text=="0")
            {
